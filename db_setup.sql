...
DROP TABLE IF EXISTS pc_canvas_2023_10; -- and for October 2023 too
...
INSERT INTO pc_canvas_list (disp_name, tab_name, c_date, is_read_only) VALUES ('Test Canvas (read only)', 'pc_canvas_2023_09', '2023-09-01', TRUE);
...
CREATE TABLE pc_canvas_2023_10 (
    p_id                INT             NOT NULL    AUTO_INCREMENT,
    p_time              TIMESTAMP       NOT NULL    DEFAULT         (CURRENT_TIMESTAMP),
    color               INT             NOT NULL,
    user_id             INT             NOT NULL,
...
INSERT INTO pc_canvas_list (disp_name, tab_name) VALUES ('Test Canvas', 'pc_canvas_2023_10');
